...
import { LayoutGrid, Music, Plus } from "lucide-react"; // Removed unused icons
...
export default function Dashboard() {
  return (
    <div className="flex h-screen bg-black text-white overflow-hidden font-sans">
      ...
      {/* CLEAN SIDEBAR (Matches Soundscapes) */}
      ...
      <main className="flex-1 overflow-auto relative">
        ...
        <div className="relative z-10 p-8 lg:p-12 max-w-7xl mx-auto space-y-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                {/* Mission Log (The ONLY place for tasks now) */}
                <div className="h-64 rounded-3xl bg-zinc-900/50 border border-white/5 p-8 hover:border-white/10 transition group flex flex-col">
                     <div className="flex justify-between items-start mb-6">
                        <div className="p-3 bg-blue-500/10 rounded-full text-blue-400">
                           {/* Replaced Icon with simple text header to be cleaner */}
